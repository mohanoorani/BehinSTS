...
namespace Skoruba.IdentityServer4.Admin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                typeof(IdentityMapperProfile<RoleDto<string>, string, UserRolesDto<RoleDto<string>, string, string>,
                    string, UserClaimsDto<string>, UserClaimDto<string>, UserProviderDto<string>,
                    UserProvidersDto<string>, UserChangePasswordDto<string>, RoleClaimDto<string>, RoleClaimsDto<string>
                >)
            };

            services
                .AddAdminAspNetIdentityServices<AdminIdentityDbContext, IdentityServerPersistedGrantDbContext,AdminLogDbContext,
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        ...
                        {
                            AuthorizationUrl =
                                new Uri($"{adminApiConfiguration.IdentityServerBaseUrl}/connect/authorize"),
            ...
            services
                .AddIdSHealthChecks<IdentityServerConfigurationDbContext, IdentityServerPersistedGrantDbContext,
                    AdminIdentityDbContext, AdminLogDbContext, AdminAuditLogDbContext>(Configuration,
