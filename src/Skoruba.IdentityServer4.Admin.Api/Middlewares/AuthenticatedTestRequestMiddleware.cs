    ...
    public class AuthenticatedTestRequestMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            if (context.Request.Headers.Keys.Contains(TestAuthorizationHeader))
            {
                ...
                var claimsIdentityy = new ClaimsIdentity(jwt.Claims, IdentityServerAuthenticationDefaults.AuthenticationScheme, JwtClaimTypes.Id, JwtClaimTypes.Id);
                context.User = new ClaimsPrincipal(claimsIdentityy);
            }
